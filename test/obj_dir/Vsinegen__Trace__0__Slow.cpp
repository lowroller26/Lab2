...
VL_ATTR_COLD void Vsinegen___024root__trace_init_sub__TOP__0(Vsinegen___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+5,"data_out1", false,-1, 7,0);
    tracep->declBus(c+6,"data_out2", false,-1, 7,0);
...
VL_ATTR_COLD void Vsinegen___024root__trace_full_sub_0(Vsinegen___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+5,(vlSelf->data_out1),8);
    bufp->fullCData(oldp+6,(vlSelf->data_out2),8);
    bufp->fullCData(oldp+7,(vlSelf->sinegen__DOT__addr),8);
    bufp->fullCData(oldp+8,((0xffU & ((IData)(vlSelf->sinegen__DOT__addr) 
                                      + (IData)(vlSelf->incr)))),8);
