...
void Vsinegen___024root__trace_chg_sub_0(Vsinegen___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+4,(vlSelf->data_out1),8);
    bufp->chgCData(oldp+5,(vlSelf->data_out2),8);
    bufp->chgCData(oldp+6,(vlSelf->sinegen__DOT__addr),8);
    bufp->chgCData(oldp+7,((0xffU & ((IData)(vlSelf->sinegen__DOT__addr) 
                                     + (IData)(vlSelf->incr)))),8);
}
