...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Init
    CData/*7:0*/ __Vdly__sigdelay__DOT____Vcellout__myCounter__dout;
    ...
    // Body
    __Vdly__sigdelay__DOT____Vcellout__myCounter__dout 
        = vlSelf->sigdelay__DOT____Vcellout__myCounter__dout;
    __Vdlyvset__sigdelay__DOT__myRam__DOT__ram_array__v0 = 0U;
    vlSelf->mic_signal_out = vlSelf->mic_signal_in;
    __Vdly__sigdelay__DOT____Vcellout__myCounter__dout 
        = ((IData)(vlSelf->rst) ? 0U : (0xffU & ((IData)(1U) 
                                                 + (IData)(vlSelf->sigdelay__DOT____Vcellout__myCounter__dout))));
    if (vlSelf->rd) {
        vlSelf->delayed_signal = vlSelf->sigdelay__DOT__myRam__DOT__ram_array
            [(0x1ffU & ((IData)(vlSelf->sigdelay__DOT____Vcellout__myCounter__dout) 
                        + (IData)(vlSelf->offset)))];
    }
    if (vlSelf->wr) {
        __Vdlyvval__sigdelay__DOT__myRam__DOT__ram_array__v0 
            = vlSelf->mic_signal_in;
