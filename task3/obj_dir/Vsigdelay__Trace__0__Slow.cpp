...
VL_ATTR_COLD void Vsigdelay___024root__trace_init_sub__TOP__0(Vsigdelay___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+5,"mic_signal_in", false,-1, 7,0);
    tracep->declBus(c+6,"offset", false,-1, 7,0);
    tracep->declBus(c+7,"delayed_signal", false,-1, 7,0);
    tracep->declBus(c+8,"mic_signal_out", false,-1, 7,0);
...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+5,(vlSelf->mic_signal_in),8);
    bufp->fullCData(oldp+6,(vlSelf->offset),8);
    bufp->fullCData(oldp+7,(vlSelf->delayed_signal),8);
    bufp->fullCData(oldp+8,(vlSelf->mic_signal_out),8);
    bufp->fullSData(oldp+9,(vlSelf->sigdelay__DOT____Vcellout__myCounter__dout),9);
    bufp->fullCData(oldp+10,(vlSelf->sigdelay__DOT____Vcellout__myCounter__dout),8);
    bufp->fullSData(oldp+11,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT____Vcellout__myCounter__dout) 
