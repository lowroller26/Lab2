...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+4,(vlSelf->mic_signal_in),8);
    bufp->chgCData(oldp+5,(vlSelf->offset),8);
    bufp->chgCData(oldp+6,(vlSelf->delayed_signal),8);
    bufp->chgCData(oldp+7,(vlSelf->mic_signal_out),8);
    bufp->chgSData(oldp+8,(vlSelf->sigdelay__DOT____Vcellout__myCounter__dout),9);
    bufp->chgCData(oldp+9,(vlSelf->sigdelay__DOT____Vcellout__myCounter__dout),8);
    bufp->chgSData(oldp+10,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT____Vcellout__myCounter__dout) 
